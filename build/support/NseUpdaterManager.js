...
const entitlementsFileName = `FirebaseImageNotificationServiceExtension.entitlements`;
const plistFileName = `FirebaseImageNotificationServiceExtension-Info.plist`;
