...
exports.withFirebaseMessagingIos = void 0;
...
const withAppGroupPermissions = (config) => {
    ...
    return (0, config_plugins_1.withEntitlementsPlist)(config, (newConfig) => {
        ...
        const entitlement = `group.${((_a = newConfig === null || newConfig === void 0 ? void 0 : newConfig.ios) === null || _a === void 0 ? void 0 : _a.bundleIdentifier) || ""}.firebase-image-notification-service-extension`;
...
const withFirebaseMessagingPodfile = (config) => {
...
const withFirebaseMessagingNSE = (config, props) => {
    ...
    return (0, config_plugins_1.withDangerousMod)(config, [
        ...
        async (config) => {
            ...
            await nseUpdater.updateNSEEntitlements(`group.${(_b = config.ios) === null || _b === void 0 ? void 0 : _b.bundleIdentifier}.firebase-image-notification-service-extension`);
...
const withFirebaseMessagingXcodeProject = (config, props) => {
...
const withFirebaseMessagingIos = (config, props) => {
    ...
    config = withFirebaseMessagingPodfile(config, props);
    config = withFirebaseMessagingNSE(config, props);
    config = withFirebaseMessagingXcodeProject(config, props);
    config = withEasManagedCredentials(config, props);
    return config;
};
exports.withFirebaseMessagingIos = withFirebaseMessagingIos;
