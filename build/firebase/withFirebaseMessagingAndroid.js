...
exports.withFirebaseMessagingAndroid = void 0;
...
const withFirebaseMessagingAndroid = (config, props) => {
    config = withSmallIcons(config, props);
    config = withLargeIcons(config, props);
    config = withSmallIconAccentColor(config, props);
    return config;
};
exports.withFirebaseMessagingAndroid = withFirebaseMessagingAndroid;
